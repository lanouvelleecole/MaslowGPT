...
export const AddCommandPromptsChoices = {
  AddCommandPromptsChoice1: ``,
  AddCommandPromptsChoice2: ``,
  AddCommandPromptsChoice3: ``,
};

export const AddCommandPromptsPromptChoices = (appRootPath) => {
  return {
    type: "list",
    ...
    default: (data) => {
      return (
        getDataFromNPMMaslowJSON("AddCommandPrompts") ??
        AddCommandPromptsChoices.AddCommandPromptsChoice1
      );
    },
    ...
    choices: [
      // AJOUTE_TEMPLATE //
      AddCommandPromptsChoices.AddCommandPromptsChoice1,
      AddCommandPromptsChoices.AddCommandPromptsChoice2,
      AddCommandPromptsChoices.AddCommandPromptsChoice3,
    ],
  };
};

export const AddCommandPromptsPromptChoicesFolders = (appRootPath) => {
  return {
    type: "list",
    name: "AddCommandPrompts",
    message: ``,
...
export const AddCommandPromptsPromptChoicesFiles = (appRootPath) => {
  return {
    type: "list",
    name: "AddCommandPrompts",
    message: ``,
