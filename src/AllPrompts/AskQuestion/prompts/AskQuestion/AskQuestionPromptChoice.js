...
export const AskQuestionChoices = {
  AskQuestionChoice1: ``,
  AskQuestionChoice2: ``,
  AskQuestionChoice3: ``,
};

export const AskQuestionPromptChoices = (appRootPath) => {
  return {
    type: "list",
    name: "AskQuestion",
    message: ``,
    ...
    default: (data) => {
      return (
        getDataFromNPMMaslowJSON("AskQuestion") ??
        AskQuestionChoices.AskQuestionChoice1
      );
    },
    ...
    choices: [
      // AJOUTE_TEMPLATE //
      AskQuestionChoices.AskQuestionChoice1,
      AskQuestionChoices.AskQuestionChoice2,
      AskQuestionChoices.AskQuestionChoice3,
    ],
  };
};

export const AskQuestionPromptChoicesFolders = (appRootPath) => {
  return {
    type: "list",
    name: "AskQuestion",
    message: ``,
...
export const AskQuestionPromptChoicesFiles = (appRootPath) => {
  return {
    type: "list",
    name: "AskQuestion",
    message: ``,
