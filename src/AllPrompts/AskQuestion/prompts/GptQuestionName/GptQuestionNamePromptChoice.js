...
export const GptQuestionNameChoices = {
  GptQuestionNameChoice1: ``,
  GptQuestionNameChoice2: ``,
  GptQuestionNameChoice3: ``,
};

export const GptQuestionNamePromptChoices = (appRootPath) => {
  return {
    type: "list",
    ...
    default: (data) => {
      return (
        getDataFromNPMMaslowJSON("GptQuestionName") ??
        GptQuestionNameChoices.GptQuestionNameChoice1
      );
    },
    ...
    choices: [
      // AJOUTE_TEMPLATE //
      GptQuestionNameChoices.GptQuestionNameChoice1,
      GptQuestionNameChoices.GptQuestionNameChoice2,
      GptQuestionNameChoices.GptQuestionNameChoice3,
    ],
  };
};

export const GptQuestionNamePromptChoicesFolders = (appRootPath) => {
  return {
    type: "list",
    name: "GptQuestionName",
    message: ``,
...
export const GptQuestionNamePromptChoicesFiles = (appRootPath) => {
  return {
    type: "list",
    name: "GptQuestionName",
    message: ``,
