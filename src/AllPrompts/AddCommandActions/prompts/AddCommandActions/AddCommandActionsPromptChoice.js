...
export const AddCommandActionsChoices = {
  AddCommandActionsChoice1: ``,
  AddCommandActionsChoice2: ``,
  AddCommandActionsChoice3: ``,
};

export const AddCommandActionsPromptChoices = (appRootPath) => {
  return {
    type: "list",
    ...
    default: (data) => {
      return (
        getDataFromNPMMaslowJSON("AddCommandActions") ??
        AddCommandActionsChoices.AddCommandActionsChoice1
      );
    },
    ...
    choices: [
      // AJOUTE_TEMPLATE //
      AddCommandActionsChoices.AddCommandActionsChoice1,
      AddCommandActionsChoices.AddCommandActionsChoice2,
      AddCommandActionsChoices.AddCommandActionsChoice3,
    ],
  };
};

export const AddCommandActionsPromptChoicesFolders = (appRootPath) => {
  return {
    type: "list",
    name: "AddCommandActions",
    message: ``,
...
export const AddCommandActionsPromptChoicesFiles = (appRootPath) => {
  return {
    type: "list",
    name: "AddCommandActions",
    message: ``,
