...
import { ExtractSrcObject } from "./ExtractSrcObject/ExtractSrcObject.js";
import { TranslateSrc } from "./TranslateSrc/TranslateSrc.js";
 ...
 */
function SetTranslateStringsAsyncActions(plop, appRootPath) {
  // PLOP_ASYNC_ACTION_USE
	ExtractSrcObject(plop, appRootPath);
	TranslateSrc(plop, appRootPath);
...
export { SetTranslateStringsAsyncActions };
