...
import { SetNewAIModel } from "./SetNewAIModel/SetNewAIModel.js";
 ...
 */
function SetSetAiModelAsyncActions(plop, appRootPath) {
  // PLOP_ASYNC_ACTION_USE
	SetNewAIModel(plop, appRootPath);
...
export { SetSetAiModelAsyncActions };
