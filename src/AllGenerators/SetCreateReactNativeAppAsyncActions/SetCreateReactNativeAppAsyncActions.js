...
import { CloneTemplate } from "./CloneTemplate/CloneTemplate.js";
import { ReplaceWordsInFolder } from "./ReplaceWordsInFolder/ReplaceWordsInFolder.js";
 ...
 */
function SetCreateReactNativeAppAsyncActions(plop, appRootPath) {
  // PLOP_ASYNC_ACTION_USE
	CloneTemplate(plop, appRootPath);
	ReplaceWordsInFolder(plop, appRootPath);
...
export { SetCreateReactNativeAppAsyncActions };
