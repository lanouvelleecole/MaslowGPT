...
import { TestSubpageQuestionList } from "./TestSubpageQuestionList/TestSubpageQuestionList";
 ...
 * un GetUserInput de création d'item dans TestSubpage.
 */
export const TestSubpage = () => {
  /* PLOP_INJECT_CODE */
  ...
  const questions = TestSubpageQuestionList();
