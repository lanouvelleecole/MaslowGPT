...
// Le AsyncThunk de récupération/triage de toutes les données stockées dans WorkListsState.
 ...
 *
 * @returns la liste de tous les WorkListsState (rows {key: value}).
 *
 ...
 */
export const InitWorkListsState = ({ onSuccess, onError, debugMode }) => {
