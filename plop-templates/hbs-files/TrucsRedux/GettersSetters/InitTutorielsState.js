...
// Le AsyncThunk de récupération/triage de toutes les données stockées dans TutorielsState.
 ...
 *
 * @returns la liste de tous les TutorielsState (rows {key: value}).
 *
 ...
 */
export const InitTutorielsState = ({ onSuccess, onError, debugMode }) => {
