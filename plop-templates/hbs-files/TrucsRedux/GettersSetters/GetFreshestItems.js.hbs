...
/**
 *
 * permet d'obtenir les plus récents WorkListsState stockés dans Redux/Sqlite
 *
 ...
 *
 */
export const GetFreshestWorkListsState = () => {
  return useSelector((state) => state.WorkListsState.allRows);
};
