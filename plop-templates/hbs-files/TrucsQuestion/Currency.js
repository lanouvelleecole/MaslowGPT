...
/**
 *
 * La question nommée Currency, qui ....
 */
const Currency = () => {
  /* PLOP_INJECT_CODE */
  ...
  return {
    ...
    description: ({ answers, answer, answerIndex }) => {
      return i18n.t("description_string_name");
    },
