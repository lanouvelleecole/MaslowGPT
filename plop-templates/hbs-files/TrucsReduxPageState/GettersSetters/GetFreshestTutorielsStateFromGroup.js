 ...
 * TutorielsState stocké dans Redux.
...
export function GetFreshestTutorielsStateFromGroup({ groupName }) {
  return useSelector((state) => state.TutorielsState.groups[groupName]) ?? [];
}
