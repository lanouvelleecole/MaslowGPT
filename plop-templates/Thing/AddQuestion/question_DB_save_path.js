...
const question_DB_save_path = (appRootPath) => {
  return {
    type: "list",

    // Variable name for this input
    name: "question_DB_save_path",

    // Prompt to display on command line
    message: `
*************************************
Quel est le path du fichier .js où on sauvegarde la réponse, via SqliteRedux<PageName>.AddRowToDatabase ?`,
